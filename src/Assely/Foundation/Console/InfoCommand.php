...
class InfoCommand extends Command
{
    ...
    {
        $assets = $this->app->make('assets')->all();
    ...
    {
        $routes = $this->app->make('routes')->all();
    ...
    {
        $sidebars = $this->app->make('sidebars')->all();
    ...
    {
        $actions = $this->app->make('actions')->all();

        $headers = ['Action name', 'Accessibility'];
